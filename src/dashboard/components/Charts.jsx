  ...
  const roundData = useMemo(() => {
    ...
    for (let r = 1; r <= rounds; r++) {
      const roundContribs = contributions
        .filter((c) => c.round === r && c.type !== "reflection" && c.type !== "query_response" && c.type !== "perspective_response" && c.type !== "critique_response" && c.type !== "evidence_response" && c.type !== "summoned_response" && c.type !== "vote_response" && c.type !== "vote_tally")
        .slice()
        .sort((a, b) =>
