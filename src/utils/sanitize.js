...
const DIRECTIVE_PATTERN = /\[(PASS|PROPOSE|CHALLENGE|REFINE|SUPPORT|DISSENT|SYNTHESIZE|QUESTION|REFUSE|INTERJECT:[^\]]*|YIELD|CONTEST[^\]]*|GOVERNANCE:[^\]]*|#\d+|NEXT:[^\]]*|VETO|FORCE_END|CALL_VOTE|REQUEST_NEXT:[^\]]*)\]/gi;
